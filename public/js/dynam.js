// ---------- Data (démo) ----------
  const PRODUCTS = [
    {
      id:'the-detox', name:'Thé Détox Vital', price:4500, stock:42,
    ...
    {
      id:'bruleur-pro', name:'Brûleur Pro+ Caps', price:9500, stock:18,
    ...
    {
      id:'shaker', name:'Shaker VitalFit 600ml', price:3500, stock:60,
      short:'Shaker anti‑fuite avec boule mélangeuse acier.',
      images:[
        'image/prod_pop_2.webp'
      ],
    ...
    {
      id:'proteine', name:'Protéine Végétale 1kg', price:16500, stock:25,
      short:'Mix pois/riz, 23g de protéines/portion, arôme vanille.',
      images:[
        'image/prod_pop_3.webp',
        'image/prod_pop_1.jpeg'
      ],
      category:'compléments',
      details:{
  ...
  function sendMsg(){
    ...
    setTimeout(()=> pushMsg('Merci ! Un conseiller vous répondra sous peu. (démo)'), 600);
  }
